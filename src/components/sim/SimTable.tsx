              ...
              return (
                <React.Fragment key={sim.id}>
                  ...
                  >
                    ...
                    <TableCell>{(sim.current_status === "Deactivated" || sim.current_status === "Inactive" || sim.current_status === "Spam") ? "—" : (sim.agent_name || "—")}</TableCell>
                    <TableCell>{(sim.current_status === "Deactivated" || sim.current_status === "Inactive" || sim.current_status === "Spam") ? "—" : (sim.project_name || "—")}</TableCell>
                    <TableCell>
